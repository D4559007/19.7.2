...
from settings import valid_password, valid_email, invalid_email, invalid_age
import os
...
def test_add_new_pet_with_valid_data(name='Largus11', animal_type='cat', age='3', pet_photo='images/cat4.jpeg'):
...
def test_add_new_pet_with_invalid_age_failed(name='Kowa', animal_type='cat', age=invalid_age, pet_photo='images/cat4.jpeg'):
...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "Larg", "пес", '1', "images/dog4.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_successful_update_self_pet_info(name='Афоня', animal_type='собака', age='7'):
...
def test_successful_update_self_pet_photo(pet_photo='images/dog4.jpeg'):
